...
(function(shared, vue) {
  ...
  var __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$8], ["__scopeId", "data-v-dd94a2a8"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/uni_modules/uni-number-box/components/uni-number-box/uni-number-box.vue"]]);
  ...
  var __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$7], ["__scopeId", "data-v-a2e81f6e"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  const tabBar = {
    ...
    iconWidth: "24px",
    spacing: "3px",
    iconfontSrc: "static/customicons.ttf",
    list: [
      {
  ...
  const d = true, f = "app", g = h({}.UNICLOUD_DEBUG), p = h("[]");
  let y = "";
  try {
    y = "__UNI__3A2FE7F";
  } catch (e) {
...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), o3(r4);
  ...
  function $t(e) {
    e.onNeedLogin = function(e2) {
      ...
      D(b, e2);
    }, Rt && (w("uni-cloud-status").needLoginInit || (w("uni-cloud-status").needLoginInit = true, Mt.call(e), Lt && jt.call(e)));
  }
  function Kt(e) {
    !function(e2) {
  ...
  var __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$6], ["__scopeId", "data-v-6b64008e"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/uni_modules/uni-data-select/components/uni-data-select/uni-data-select.vue"]]);
  const _sfc_main$7 = {
    name: "UniSection",
    emits: ["click"],
    props: {
  ...
  var __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$5], ["__scopeId", "data-v-5584ec96"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/components/uni-section/uni-section.vue"]]);
  const _sfc_main$6 = {
    name: "UniBadge",
    emits: ["click"],
    props: {
  ...
  var __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$4], ["__scopeId", "data-v-7c66581c"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/uni_modules/uni-badge/components/uni-badge/uni-badge.vue"]]);
  const _sfc_main$5 = {
    name: "UniListItem",
  ...
  var __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$3], ["__scopeId", "data-v-296a3d7e"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/uni_modules/uni-list/components/uni-list-item/uni-list-item.vue"]]);
  const _sfc_main$4 = {
    name: "uniList",
    "mp-weixin": {
      options: {
  ...
  var __easycom_5 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$2], ["__scopeId", "data-v-5009d455"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/uni_modules/uni-list/components/uni-list/uni-list.vue"]]);
  const _sfc_main$3 = {
    name: "UniDrawer",
    components: {},
    emits: ["change"],
  ...
  var __easycom_6 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$1], ["__scopeId", "data-v-558f1882"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/uni_modules/uni-drawer/components/uni-drawer/uni-drawer.vue"]]);
  const urlConfigData = {
    "/hzfucai": "http://www.hzfucai.net"
  };
  const generatorUrl = (url) => {
    const r2 = Object.keys(urlConfigData).find((key) => url.startsWith(key));
    if (r2)
      return url.replace(r2, urlConfigData[r2]);
  };
  function urlParser(sourceUrl) {
    let url = sourceUrl;
  ...
  function getDoubleColorBallData(data) {
    return request({
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    __name: "index",
    setup(__props) {
      const dobuleColorBallFieldNum = vue.ref([]);
      const leftDrawerRef = vue.ref();
      const dobuleColorBallDetails = vue.ref([]);
      const num = vue.ref(5);
      const randomList = vue.ref([]);
      const getDoubleColorBall = async () => {
        try {
          const result = await getDoubleColorBallData();
          dobuleColorBallFieldNum.value = result.qbqh.split(",");
          dobuleColorBallDetails.value = result.zjxq;
        } catch (err) {
          formatAppLog("log", "at pages/index/index.vue:21", err);
        }
      };
      const handleRandomStartClick = () => {
        const resultList = [];
        for (let i2 = 0; i2 < num.value; i2++) {
        ...
        formatAppLog("log", "at pages/index/index.vue:46", randomList.value);
      };
      const handleShowLeftChange = (flag) => {
        var _a;
        const fn = flag ? "open" : "close";
        (_a = leftDrawerRef.value) == null ? void 0 : _a[fn]();
      };
      setTimeout(() => {
        handleRandomStartClick();
        handleShowLeftChange(true);
      }, 1e3);
      getDoubleColorBall();
      return (_ctx, _cache) => {
        ...
        const _component_uni_drawer = resolveEasycom(vue.resolveDynamicComponent("uni-drawer"), __easycom_6);
        return vue.openBlock(), vue.createElementBlock("view", { class: "wd-text-36r" }, [
          vue.createElementVNode("view", { class: "wd-flex-center" }, [
            vue.createElementVNode("text", { class: "wd-mx-auto" }, "\u673A\u9009"),
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(dobuleColorBallFieldNum.value, (detail, i2) => {
            var _a, _b;
            return vue.openBlock(), vue.createElementBlock("view", {
              key: i2,
              class: "wd-py-20r"
            }, [
              vue.createElementVNode("view", { class: "wd-text-center" }, [
                vue.createTextVNode(" \u7B2C " + vue.toDisplayString(detail) + " \u671F \u5956\u6C60\u6EDA\u5B58: ", 1),
                vue.createElementVNode("text", { style: { "color": "red" } }, "\uFFE5" + vue.toDisplayString((_a = dobuleColorBallDetails.value[i2]) == null ? void 0 : _a.jcje) + "\u5143", 1)
              ]),
              vue.createElementVNode("view", { class: "wd-flex-center" }, [
                vue.createElementVNode("img", {
                  class: "wd-w-100r wd-h-100r",
                  src: "http://www.hzfucai.net/statics/images/index/gg01.png"
                }),
                vue.createElementVNode("view", { class: "wd-flex-center wd-text-center wd-leading-60r" }, [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList((_b = dobuleColorBallDetails.value[i2]) == null ? void 0 : _b.kjjgqq.split(" "), (ball, j2) => {
                    return vue.openBlock(), vue.createElementBlock("view", {
                      key: j2,
                      class: "wd-w-60r wd-h-60r wd-rounded-full wd-mr-10r wd-text-white",
                      style: { "background-color": "#e60013" }
                    }, vue.toDisplayString(ball), 1);
                  }), 128)),
                  vue.createElementVNode("view", {
                    class: "wd-w-60r wd-h-60r wd-rounded-full wd-text-white",
                    style: { "background-color": "aqua" }
                  }, vue.toDisplayString(dobuleColorBallDetails.value[i2].kjjghq), 1)
                ])
              ])
            ]);
          }), 128)),
          vue.createVNode(_component_uni_drawer, {
            class: "drawer",
            width: 300,
            onClick: _cache[4] || (_cache[4] = ($event) => handleShowLeftChange(false)),
            ref_key: "leftDrawerRef",
            ref: leftDrawerRef,
            mode: "left"
          }, {
            default: vue.withCtx(() => [
              vue.createElementVNode("view", {
                class: "wd-float-right",
                onClick: _cache[2] || (_cache[2] = ($event) => handleShowLeftChange(false))
              }, [
                vue.createVNode(_component_uni_icons, {
                  type: "close",
                  size: "30"
              ...
              vue.createElementVNode("view", { class: "wd-mt-30r" }, [
                vue.createVNode(_component_uni_section, {
                  title: `\u673A\u9009${num.value}\u6CE8`,
                  type: "line"
                }, null, 8, ["title"]),
                vue.createVNode(_component_uni_list, { class: "wd-p-5 wd-text-12" }, {
                  default: vue.withCtx(() => [
                    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(randomList.value, (random, index) => {
                      return vue.openBlock(), vue.createBlock(_component_uni_list_item, {
                        key: index,
                        class: "wd-flex-center wd-text-center wd-leading-30"
                      }, {
                        body: vue.withCtx(() => [
                          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(random, (ball, i2) => {
                            return vue.openBlock(), vue.createElementBlock("div", {
                              key: i2,
                              class: "wd-w-30 wd-h-30 wd-rounded-full wd-mr-5 wd-text-white",
                              style: vue.normalizeStyle({ "background-color": i2 < 6 ? "#e60013" : "aqua" })
                            }, vue.toDisplayString(ball), 5);
                          }), 128))
                        ]),
                        _: 2
                      }, 1024);
  ...
  var PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/pages/index/index.vue"]]);
  const _sfc_main$1 = {};
  function _sfc_render(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("div", null, "mine");
  }
  var PagesMineIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/pages/mine/index.vue"]]);
  ...
  var App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/Administrator/Documents/HBuilderProjects/ticket/App.vue"]]);
  function createApp() {
